$report='P:\MGunes\DuplexerTestSuite\Results\GaugeRR_SimRun_20260604_094207_Data\GaugeRR_Report_Sim.html'
Get-Content -Raw -Path $report | Out-Null
...
$out='D:\VSCodeRepo\DuplexerFinalTest\gauge_rr_csv_check_sim_full.csv'
